 ...
 * @author Ralph Küpper
 */
class BirthdayFormElement extends FormElement {
	/** The options. */
	public $options;
	/** The index of the current option. */
	public $selectedOption;
	/** The static template. You can change it. */
	public static $TEMPLATE = '<select class="days" onchange="changeDays(this);" name="birthday_day">{optionsDays}</select> <select class="months" onchange="changeDays(this);" name="birthday_month">{optionsMonths}</select> <select class="years" onchange="changeDays(this);" name="birthday_year">{optionsYears}</select>{msg}';
	...
	public function render() {
		$tpl = BirthdayFormElement::$TEMPLATE;
